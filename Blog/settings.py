...
SECRET_KEY = 'django-insecure-=p^4o#m)5f^g)g(i49cf1(963(-lvfn%exceq%kuv5-w--xhc5'
...
INSTALLED_APPS = [
    #Instala o aplicativo BlogApp
    'BlogApp.apps.BlogappConfig',
    #Instala o Aplicativo users para lidar com logins registros e afins
    'users.apps.UsersConfig',
    #instala o Crispy para tornar os forms mais apresentáveis
    'crispy_forms',
    'crispy_bootstrap4',
